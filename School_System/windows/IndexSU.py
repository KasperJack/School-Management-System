...
#################### students table ##############################
    ...
    def load_classes_table(self):
        ...
        for row_index, row_data in enumerate(results):
            ...
            edit_button.setStyleSheet(""" /* Base Style for All Buttons */
QPushButton {
...
QPushButton:pressed {
 ...
 """)
            delete_button.setStyleSheet(""" /* Base Style for All Buttons */
QPushButton {
    background-color: #f0f0f0; /* Light gray background */
    color: #000000; /* Black text */
    border: 1px solid #cccccc; /* Light gray border */
...
QPushButton:pressed {
    ...
    border: 1px solid #5a1400; /* Darkest red border when pressed */
            ...
            view_button.setStyleSheet(""" /* Base Style for All Buttons */
QPushButton {
    background-color: #f0f0f0; /* Light gray background */
    color: #000000; /* Black text */
    border: 1px solid #cccccc; /* Light gray border */
